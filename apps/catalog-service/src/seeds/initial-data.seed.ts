...
const SEED_PRODUCTS: SeedProduct[] = [
  // ── Services (SaaS) ──────────────────────────────────────────────
  {
    ...
    images: [
      ...
      },
      {
        ...
        altTextFr: 'Analyste SOC au travail',
        altTextEn: 'SOC analyst at work',
        displayOrder: 3,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1504384764586-bb4cdc1707b0?w=800&q=80',
        altTextFr: 'Salle serveur sécurisée',
        altTextEn: 'Secure server room',
        displayOrder: 4,
        isPrimary: false,
      },
      {
  ...
  },
  {
    ...
    images: [
      ...
      },
      {
        ...
        altTextFr: 'Détection de menaces',
        altTextEn: 'Threat detection',
        displayOrder: 3,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1504384764586-bb4cdc1707b0?w=800&q=80',
        altTextFr: 'Serveur protégé',
        altTextEn: 'Protected server',
        displayOrder: 4,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1551808525-51a94da548ce?w=800&q=80',
        altTextFr: 'Interface de monitoring',
        altTextEn: 'Monitoring interface',
        displayOrder: 5,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1563986768609-322da13575f2?w=800&q=80',
        altTextFr: 'Centre de contrôle EDR',
        altTextEn: 'EDR control center',
        displayOrder: 6,
        isPrimary: false,
      },
    ],
  },
  {
    ...
    images: [
      ...
      {
        imageUrl: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&q=80',
        altTextFr: 'Visualisation des données',
        altTextEn: 'Data visualization',
        displayOrder: 3,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=800&q=80',
        altTextFr: 'Dashboard unifiée XDR',
        altTextEn: 'Unified XDR dashboard',
        displayOrder: 4,
        isPrimary: false,
      },
    ],
  },
  {
    ...
    images: [
      ...
      {
        imageUrl: 'https://images.unsplash.com/photo-1551808525-51a94da548ce?w=800&q=80',
        altTextFr: 'Graphes de menaces',
        altTextEn: 'Threat graphs',
        displayOrder: 2,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1563986768609-322da13575f2?w=800&q=80',
        altTextFr: 'Rapports IoC',
        altTextEn: 'IoC reports',
        displayOrder: 3,
        isPrimary: false,
      },
    ],
  ...
  // ── Produits physiques ────────────────────────────────────────────
  {
    ...
    images: [
      ...
      {
        imageUrl: 'https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?w=800&q=80',
        altTextFr: 'Authentification sécurisée',
        altTextEn: 'Secure authentication',
        displayOrder: 3,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&q=80',
        altTextFr: 'Chiffrement des données',
        altTextEn: 'Data encryption',
        displayOrder: 4,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=800&q=80',
        altTextFr: 'Intégration développeur',
        altTextEn: 'Developer integration',
        displayOrder: 5,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=800&q=80',
        altTextFr: 'Sécurité multi-facteurs',
        altTextEn: 'Multi-factor security',
        displayOrder: 6,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1597852074816-d933c7d2b988?w=800&q=80',
        altTextFr: 'Clé USB hardware',
        altTextEn: 'Hardware USB key',
        displayOrder: 7,
        isPrimary: false,
      },
    ],
  },
  {
    ...
    images: [
      ...
      {
        imageUrl: 'https://images.unsplash.com/photo-1551808525-51a94da548ce?w=800&q=80',
        altTextFr: 'Panneau de connexions réseau',
        altTextEn: 'Network patch panel',
        displayOrder: 3,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1563986768609-322da13575f2?w=800&q=80',
        altTextFr: 'Câblage structuré',
        altTextEn: 'Structured cabling',
        displayOrder: 4,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1504384764586-bb4cdc1707b0?w=800&q=80',
        altTextFr: 'Data center',
        altTextEn: 'Data center',
        displayOrder: 5,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1562813733-b31f71025d54?w=800&q=80',
        altTextFr: 'Interface de gestion firewall',
        altTextEn: 'Firewall management interface',
        displayOrder: 6,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=800&q=80',
        altTextFr: 'Monitoring réseau',
        altTextEn: 'Network monitoring',
        displayOrder: 7,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1555949963-aa79dcee981c?w=800&q=80',
        altTextFr: 'Configuration réseau',
        altTextEn: 'Network configuration',
        displayOrder: 8,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1573164713988-8665fc963095?w=800&q=80',
        altTextFr: 'Installation en rack',
        altTextEn: 'Rack installation',
        displayOrder: 9,
        isPrimary: false,
      },
    ],
  ...
  // ── Licences ────────────────────────────────────────────────────
  {
    ...
    images: [
      ...
      {
        imageUrl: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=800&q=80',
        altTextFr: 'Développement et productivité',
        altTextEn: 'Development and productivity',
        displayOrder: 2,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1573164713988-8665fc963095?w=800&q=80',
        altTextFr: 'Travail en équipe',
        altTextEn: 'Teamwork',
        displayOrder: 3,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1555949963-aa79dcee981c?w=800&q=80',
        altTextFr: 'Gestion documentaire',
        altTextEn: 'Document management',
        displayOrder: 4,
        isPrimary: false,
      },
      {
        imageUrl: 'https://images.unsplash.com/photo-1504384764586-bb4cdc1707b0?w=800&q=80',
        altTextFr: 'Cloud sécurisé',
        altTextEn: 'Secure cloud',
        displayOrder: 5,
        isPrimary: false,
      },
    ],
